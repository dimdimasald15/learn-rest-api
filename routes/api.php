...
Route::middleware(ApiAuthMiddleware::class)->group(function () {
    ...
    Route::get('/contacts/{idContact}/addresses/{id}', [AddressController::class, 'get'])
        ->where('idContact', '[0-9]+')->where('id', '[0-9]+');
    Route::put('/contacts/{idContact}/addresses/{id}', [AddressController::class, 'update'])
        ->where('idContact', '[0-9]+')->where('id', '[0-9]+');
    Route::delete('/contacts/{idContact}/addresses/{id}', [AddressController::class, 'delete'])
        ->where('idContact', '[0-9]+')->where('id', '[0-9]+');
});
